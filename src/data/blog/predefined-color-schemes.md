...
我为这个 AstroPaper 博客主题制作了一些预定义的配色方案。您可以用这些配色方案替换原始方案。

如果您不知道如何配置配色方案，请查看[这篇博客文章](https://astro-paper.pages.dev/posts/customizing-astropaper-theme-color-schemes/)。
